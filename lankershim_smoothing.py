...
"""
This code
    1. smoothes out the noise in the local x and local y values in the Lankershim Dataset
...
def smooth_dataset(window, train, file_names):
    ...
    :param train: a list of 3 numpy arrays containing the original Lankershim data
    """
...
def main():
    ...
    # specify the path to the input Lankershim dataset and the path to the output smoothed dataset
    global path_to_dataset, path_to_smoothed_dataset
    path_to_dataset = 'C:/.../Lankershim/dataset/'
    path_to_smoothed_dataset = 'C:/.../smoothed/'


    # load the Lankershim data from the CSV files
